...
/** Input for the createPortifolio mutation. */
...
/** The payload for the createPortifolio mutation. */
export type CreatePortifolioPayload = {
  __typename?: 'CreatePortifolioPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  portifolio?: Maybe<Portifolio>;
};
...
/** Input for the deletePortifolio mutation. */
export type DeletePortifolioInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the Portifolio to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deletePortifolio mutation. */
export type DeletePortifolioPayload = {
  __typename?: 'DeletePortifolioPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
export type MenuItemObjectUnion = Category | Page | Portifolio | Post | PostFormat | Tag;
...
/** The Portifolio type */
export type Portifolio = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  ...
  /** Whether the comments are open or closed for this particular post. */
  commentStatus?: Maybe<Scalars['String']['output']>;
  /** Connection between the Portifolio type and the Comment type */
  comments?: Maybe<PortifolioToCommentConnection>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** The globally unique identifier of the portifolio object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean']['output'];
  /** Whether the object is a node in the preview state */
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  portifolioId: Scalars['Int']['output'];
  /** Connection between the Portifolio type and the Portifolio type */
  preview?: Maybe<PortifolioToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The Portifolio type */
export type PortifolioAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Portifolio type */
export type PortifolioChildrenArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Portifolio type */
export type PortifolioCommentsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<PortifolioToCommentConnectionWhereArgs>;
};


/** The Portifolio type */
export type PortifolioContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The Portifolio type */
export type PortifolioEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Portifolio type */
export type PortifolioEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The Portifolio type */
export type PortifolioExcerptArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The Portifolio type */
export type PortifolioTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to Portifolio Nodes */
export type PortifolioConnection = {
  /** A list of edges (relational context) between RootQuery and connected Portifolio Nodes */
  edges: Array<PortifolioConnectionEdge>;
  /** A list of connected Portifolio Nodes */
  nodes: Array<Portifolio>;
  /** Information about pagination in a connection. */
  pageInfo: PortifolioConnectionPageInfo;
};

/** Edge between a Node and a connected Portifolio */
export type PortifolioConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected Portifolio Node */
  node: Portifolio;
};

/** Page Info on the connected PortifolioConnectionEdge */
export type PortifolioConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Portifolio type and the Comment type */
export type PortifolioToCommentConnection = CommentConnection & Connection & {
  __typename?: 'PortifolioToCommentConnection';
  /** Edges for the PortifolioToCommentConnection connection */
  edges: Array<PortifolioToCommentConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Comment>;
  /** Information about pagination in a connection. */
  pageInfo: PortifolioToCommentConnectionPageInfo;
};

/** An edge in a connection */
export type PortifolioToCommentConnectionEdge = CommentConnectionEdge & Edge & {
  __typename?: 'PortifolioToCommentConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Comment;
...
/** Page Info on the &quot;PortifolioToCommentConnection&quot; */
export type PortifolioToCommentConnectionPageInfo = CommentConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'PortifolioToCommentConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the PortifolioToCommentConnection connection */
export type PortifolioToCommentConnectionWhereArgs = {
  /** Comment author email address. */
  authorEmail?: InputMaybe<Scalars['String']['input']>;
  /** Array of author IDs to include comments for. */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Connection between the Portifolio type and the Portifolio type */
export type PortifolioToPreviewConnectionEdge = Edge & OneToOneConnection & PortifolioConnectionEdge & {
  __typename?: 'PortifolioToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Portifolio;
...
export type RootMutation = {
  ...
  /** The createPortifolio mutation */
  createPortifolio?: Maybe<CreatePortifolioPayload>;
  ...
  /** The deletePortifolio mutation */
  deletePortifolio?: Maybe<DeletePortifolioPayload>;
  ...
  /** The updatePortifolio mutation */
  updatePortifolio?: Maybe<UpdatePortifolioPayload>;
...
/** The root mutation */
export type RootMutationCreatePortifolioArgs = {
...
/** The root mutation */
export type RootMutationDeletePortifolioArgs = {
...
/** The root mutation */
export type RootMutationUpdatePortifolioArgs = {
...
export type RootQuery = {
  ...
  /** An object of the Portifolio Type.  */
  portifolio?: Maybe<Portifolio>;
  /**
   * A Portifolio object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  portifolioBy?: Maybe<Portifolio>;
  /** Connection between the RootQuery type and the Portifolio type */
  portifolios?: Maybe<RootQueryToPortifolioConnection>;
...
/** The root entry point into the Graph */
export type RootQueryPortifolioArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<PortifolioIdType>;
};


/** The root entry point into the Graph */
export type RootQueryPortifolioByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  portifolioId?: InputMaybe<Scalars['Int']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
};


/** The root entry point into the Graph */
export type RootQueryPortifoliosArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToPortifolioConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the Portifolio type */
export type RootQueryToPortifolioConnection = Connection & PortifolioConnection & {
  __typename?: 'RootQueryToPortifolioConnection';
  /** Edges for the RootQueryToPortifolioConnection connection */
  edges: Array<RootQueryToPortifolioConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Portifolio>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToPortifolioConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToPortifolioConnectionEdge = Edge & PortifolioConnectionEdge & {
  __typename?: 'RootQueryToPortifolioConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Portifolio;
...
/** Page Info on the &quot;RootQueryToPortifolioConnection&quot; */
export type RootQueryToPortifolioConnectionPageInfo = PageInfo & PortifolioConnectionPageInfo & WpPageInfo & {
  __typename?: 'RootQueryToPortifolioConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToPortifolioConnection connection */
export type RootQueryToPortifolioConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Input for the updatePortifolio mutation. */
export type UpdatePortifolioInput = {
  ...
  /** The excerpt of the object */
  excerpt?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the Portifolio object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updatePortifolio mutation. */
export type UpdatePortifolioPayload = {
  __typename?: 'UpdatePortifolioPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  portifolio?: Maybe<Portifolio>;
